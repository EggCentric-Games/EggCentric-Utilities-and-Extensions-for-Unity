...
namespace EggCentric.StateMachines
{
    public class RequestHandler<TStateType> where TStateType : IState
    {
        ...
        public void AddRequest<TTarget>(bool isForced = false) where TTarget : class, IState, TStateType
        {
        ...
        public void AddDelayedRequest<TTarget>(float lifetime = -1f) where TTarget : class, IState, TStateType
        {
